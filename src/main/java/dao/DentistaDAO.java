...
public class DentistaDAO {
    ...
    public void inserir(Dentista d) {
        ...
        String sql = "INSERT INTO dentista (id, nome, endereco, email, telefone, cro) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void atualizar(Dentista d) {
        ...
        String sql = "UPDATE dentista SET nome=?, endereco=?, email=?, telefone=?, cro=? WHERE id=?";
